...
- **`ESC t` must come _after_ `ESC @`.** The reset clears the code page
...
The core has **zero dependencies** and compiles nothing. `usb` is an _optional
peer_: you install it yourself, and only if you print over USB. Nobody
